...
def rejestracja(request):
    if request.user.is_authenticated:
        ...
        context={'form':form}
        return render(request, 'konta/rejestracja.html',context)
...
def logowanie(request):
    ...
    context={}
    return render(request, 'konta/logowanie.html',context)
...
def home(request):
    ...
    return render(request, 'konta/dashboard.html', context)

@login_required(login_url='logowanie')
def produkty(request):
    produkty = Produkt.objects.all()

    return render(request, 'konta/produkty.html',{'produkty': produkty})
...
def produkt(request,pk):
    ...
    return render(request, 'konta/produkt.html', context)
...
def klient(request,pk_test):
    ...
    return render(request, 'konta/klient.html',context)
...
def createOrder(request):
    ...
    context = {'form':form}
    return render(request, 'konta/order_form.html', context)
...
def usunZamowienie(request,pk):
    ...
    return render(request, 'konta/usun.html', context)